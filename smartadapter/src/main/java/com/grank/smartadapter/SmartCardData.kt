 ...
 * @property cardType String        在构建SmartCardData数据时，tag表示的是实际的卡片样式id
 ...
 * -----------------------------------------------------------------
 */
data class SmartCardData(var data: Any, var cardType: String, var cardId: String = "", var cardTitle:String = "")
